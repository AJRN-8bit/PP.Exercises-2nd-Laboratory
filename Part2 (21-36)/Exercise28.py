...
"Cape Verde", "Cayman Islands", "Chad", "Chile", "China", "Colombia", "Congo",
...
"St. Lucia", "Sudan", "Suriname", "Swaziland", "Sweden", "Switzerland",
"Syria", "Taiwan", "Tajikistan", "Tanzania", "Thailand", "Timor L'Este",
...
# Finds the last countries in a list by using its first letter.

def FindCountries():
    print("-------------------------------------------------------------")
    print("Finds the last countries in a list by using its first letter.")
    print("-------------------------------------------------------------")
    print()
    ...
    try:
        foundCountries = [x for x in countries if x[0] == "Z"]  # Stores the countries that start with Z.

        print("Found countries that start with Z: ", foundCountries) # Prints the found countries.
